<template>
  <div class="registration__view-inner relative">
    <div
      class="registration__view-background h-[100vh] bg-cover bg-center bg-no-repeat filter blur-[10px]"
      :style="{
          ...
          <div class="registration__view-form h-full flex justify-center items-center">
            <div class="w-96 rounded-lg bg-[#12192C] p-8 text-gray-100">
              ...
              <div class="flex items-center pt-4">
                ...
                <p class="px-3 text-sm text-gray-400">Sign up with social accounts</p>
                <div class="flex-1 h-px bg-gray-700"></div>
              </div>
