    ...
    <div class="category__content flex gap-[45px]">
      ...
      <div class="category__content-box w-[calc(100%-200px)] mt-[45px]">
        ...
        <p class="category__content-desc mb-[55px]">
          Film genre in which the protagonist is thrust into a series of events that
          typically involve violence and physical feats. The genre tends to feature a
          mostly resourceful Hero struggling against incredible odds, which include
          life-threatening situations, a dangerous villain, or a pursuit which usually
          concludes in victory for the hero.
        </p>
